...
public class NewCaseActivity extends AppCompatActivity {
    ...
    EditText txtCaseId, txtCaseCategory, txtOfficerName;
    Button btnAddCase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddCase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Case cases = new Case(txtCaseId.getText().toString(), txtCaseCategory.getText().toString(), txtOfficerName.getText().toString(), Date);
